...
| PCB 正面 | PCB 细节 |
|:---:|:---:|
| ![PCB 正面](images/pcb_front.jpg) | ![PCB 细节 1](images/pcb_detail1.jpg) |

| PCB 细节 | 运行小智 AI |
|:---:|:---:|
| ![PCB 细节 2](images/pcb_detail2.jpg) | ![运行小智 AI](images/running_xiaozhi.jpg) |

### 3D 打印外壳

| 外壳底壳 | 后盖 |
|:---:|:---:|
| ![外壳底壳](images/case_top.png) | ![后盖](images/case_back_cover.png) |

| 前面板 | 装配透视图 |
|:---:|:---:|
| ![前面板](images/case_front_panel.png) | ![装配透视图](images/case_assembled_cad.png) |

| 实体正面 | 实体背面 |
|:---:|:---:|
| ![实体正面](images/case_physical_front.jpg) | ![实体背面](images/case_physical_back.jpg) |

---

## 购买

[点击直达淘宝购买链接](https://e.tb.cn/h.8XIUBG7R8E4iPYE?tk=bAibgGVpTex) 「AI card 卡片单片机 带扬声器，麦克风，显示屏，蓝牙 wifi」
...
| 文件 | 说明 |
|------|------|
| `case/fusion_printable_top_cover.step` | 外壳上盖（3D 打印，STEP 格式） |
| `case/fusion_printable_bottom_case.step` | 外壳底壳（3D 打印，STEP 格式） |
